 ...
 * @author lidelin.
 */
public class ConcurrentHashMapDeadLockSolution {
    ...
    private static LoadingCache<String, Object> cache = Caffeine.newBuilder()
            ...
            .build(new CacheLoader<String, Object>() {
                ...
                public Object load(@Nonnull String key) throws Exception {
                    return ConcurrentHashMapDeadLockSolution.load(key);
                }
    ...
    private static final ExecutorService BLOCKING_EXEC = Executors.newSingleThreadExecutor();
    ...
    public static void testDeadLock() {
        IntStream.range(0, 1000).mapToObj(i -> String.valueOf('a' + i))
                ...
                .map(i -> {
                    ...
                    Object obj = ConcurrentHashMapDeadLockSolution.get(i);
